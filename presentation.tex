...
\placefigure[here, none][fig1]{}{\externalfigure[noteBook1.jpg][width=.6\textwidth]}
>>>>>>> aa4b81ffce5365607b2ea0c8f7ff0b5e910a178e
...
=======
	{\externalfigure[noteBook2.jpg][width=.4\textwidth]}{}
	{\externalfigure[noteBook3.jpg][width=.4\textwidth]}{}
>>>>>>> aa4b81ffce5365607b2ea0c8f7ff0b5e910a178e
\stopcombination}
...
=======
{\externalfigure[app2.png][width=.3\textwidth]}{Multi-column layouts are possible for \quote{tabular} data. The choice of the number of columns is mainly a choice of device size: smaller androids do not deal with many columns well.}
{\externalfigure[app3.png][width=.3\textwidth]}{We support checkboxes (all in a single attribute), dropdowns, and radiobuttons. Dropdowns can have a hierarchical navigation, for rapid selection among hundreds of choices.}
>>>>>>> aa4b81ffce5365607b2ea0c8f7ff0b5e910a178e
\stopcombination
\blank
...
Each attribute has four sub-attributes reflecting the needs of field data recording and can be multivalued if multiple rows share a timestamp. An attribute can comprise a set of:
\startitemize[packed]
\item a constrained vocabulary (how we implement dropdowns, checkboxes, and radio buttons);
\item a unconstrained measurement;
\item an annotation (to represent a way of scribbling in the margins without contaminating the data); and
\item a certainty (to reflect scribbling question marks or to otherwise rate physical uncertainty of the data reliability).
\stopitemize
...
\placefigure[here,none]{}{\externalfigure[eventLog.png][width=.85\textwidth]}
>>>>>>> aa4b81ffce5365607b2ea0c8f7ff0b5e910a178e
{\setupwhitespace[big]
...
=======
%\startcombination[2*1]
\placefigure[here,none]{}{\externalfigure[oss.pdf][width=.49\textwidth]}

%{\framed[width=.49\textwidth, height=.5\textheight,  align={nothyphenated,verytolerant}, frame=off]{\setupwhitespace[big]%
